            ...
            <form wire:submit.prevent="store" class="formCreate">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" wire:model="temporary_images" multiple
                        class="form-control @error('temporary_images.*') is-invalid @enderror" id="price">
                </div>
                {{-- se c'e l'img --}}
                @if (!empty($images))
                    <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" wire:model="description" class="form-control @error('description') is-invalid @enderror"
